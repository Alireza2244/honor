...
import (
	...
	dexmodule "honor/x/dex"
	dexmodulekeeper "honor/x/dex/keeper"
	dexmoduletypes "honor/x/dex/types"
	honormodule "honor/x/honor"
	honormodulekeeper "honor/x/honor/keeper"
	honormoduletypes "honor/x/honor/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport

	appparams "honor/app/params"
	"honor/docs"
)

const (
	AccountAddressPrefix = "mi"
	Name                 = "honor"
)
...
type App struct {
	*baseapp.BaseApp
	...
	HonorKeeper     honormodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.HonorKeeper = *honormodulekeeper.NewKeeper(
		appCodec,
		keys[honormoduletypes.StoreKey],
		keys[honormoduletypes.MemStoreKey],
		app.GetSubspace(honormoduletypes.ModuleName),
	)
	honorModule := honormodule.NewAppModule(appCodec, app.HonorKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(honormoduletypes.ModuleName)
