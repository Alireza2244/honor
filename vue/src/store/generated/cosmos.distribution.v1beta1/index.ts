import { Client, registry, MissingWalletError } from 'honor-client-ts'

import { Params } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorHistoricalRewards } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorCurrentRewards } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorAccumulatedCommission } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorOutstandingRewards } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorSlashEvent } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorSlashEvents } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { FeePool } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { CommunityPoolSpendProposal } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { DelegatorStartingInfo } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { DelegationDelegatorReward } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { CommunityPoolSpendProposalWithDeposit } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { DelegatorWithdrawInfo } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorOutstandingRewardsRecord } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorAccumulatedCommissionRecord } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorHistoricalRewardsRecord } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorCurrentRewardsRecord } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { DelegatorStartingInfoRecord } from "honor-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorSlashEventRecord } from "honor-client-ts/cosmos.distribution.v1beta1/types"
